...
const OrderConfirmation = () => {
  ...
  useEffect(() => {
    ...
    // Rulăm acest effect doar o dată, la montare
  }, []);

  // Golește coșul (nu resetăm istoricul pentru a evita loop-ul)
  useEffect(() => {
    clearCart();
  }, [clearCart]);
  ...
  // Trimite emailul de confirmare, doar dacă avem un orderId, un email și date complete
  useEffect(() => {
